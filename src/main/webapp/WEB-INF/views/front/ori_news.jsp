		...
		<nav class="navbar navbar-default">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a  href="/"><h1>Games <img src="../../../resources/images/c1.png" alt=" " /> Zone</h1></a>
				</div>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="hover-effect active"><a href="/front/news">News</a></li>
						<li class="hover-effect"><a href="/front/contact">Contact</a></li>
					</ul>
				</div>
